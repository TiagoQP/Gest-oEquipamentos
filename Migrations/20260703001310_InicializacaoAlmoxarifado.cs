...
{
    /// <inheritdoc />
    public partial class InicializacaoAlmoxarifado : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AssistenteId = table.Column<int>(type: "INTEGER", nullable: false),
                    NomeProfessorBeneficiario = table.Column<string>(type: "TEXT", nullable: false),
